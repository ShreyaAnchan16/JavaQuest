...
public class java_mongo implements ActionListener {
    // MongoDB credentials
    String username = "shreyaanchan16";
    String password = "Suresh@1617";
    ...
    public java_mongo() {
        try {
            ...
            String connectionString = "mongodb+srv://" + encodedUsername + ":" + encodedPassword + "@cluster0.xdehcv3.mongodb.net/";
...
class Quiz_JFrame implements ActionListener{
    ...
    Quiz_JFrame(String name) {
        ...
        String[] questionTexts = {
                ...
                "What is the size of the primitive type char in Java?",
                "Which of the following statements is true about Java interfaces?",
                "Which data structure in Java allows null elements?"
        };
        String[][] options = {
                {"final", "static", "const", "var"},
                {"java.lang", "java.io", "java.util", "javax.swing"},
                {"4 bytes", "2 bytes", "1 bytes", "8 bytes"},
                {"Interfaces can have method implementations.", "A class can implement multiple interfaces using the extends keyword.", "Interface methods are by default static.", "Interfaces can extend multiple interfaces."},
                {"ArrayList", "Stack", "TreeSet", "HashMap"}
        };
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String[] correctAnswers = 
                {"final", "javax.swing", "2 bytes", "Interfaces can extend multiple interfaces.", "ArrayList"
                 };
